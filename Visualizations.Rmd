...
sn.boxplot(x = bp['num_procedures'], color="purple", ax=ax[0][2])
sn.boxplot(x = bp['num_medications'], color='green',ax=ax[0][3])
sn.boxplot(x = bp['number_outpatient'], color='salmon',ax=ax[1][0])
sn.boxplot(x = bp['number_emergency'], color='pink',ax=ax[1][1])
sn.boxplot(x = bp['number_inpatient'], color='firebrick',ax=ax[1][2])
sn.boxplot(x = bp['number_diagnoses'], color='blue',ax=ax[1][3])
...
These are the proportionality comparisons between different features of the data.
